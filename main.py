...
def input_error(func):
    def inner(*args, **kwargs):
        try:
            ...
            logger.exception('KeyError')  # Логгирование
            return f'Command {e} not found!!!'
        except ValueError as e:
            logger.exception('ValueError')  # Логгирование
            return e
        except IndexError as e:
            logger.exception('IndexError')  # Логгирование
...
if __name__ == '__main__':
    ...
    commands = ["contact", "noter", "sort file", "exit", "help"]
    ...
    '''
        ...
        '''
            ...
            commands = ["add contact", "delete contact",
                        ...
                        "add adress", "change adress", "delete adress",
            ...
            while True:  # CONTACT COMAND
                command = str(
                    input("Enter command (add contact, add number, delete, show, show all, find, help, return):>> ")).lower()
                logger.debug(command)  # Логгирование
                ####
                if not command in commands:
                    answer = ""
        ...
        Доступные кооманды:
          ...
          return - выход в предыдущее меню
            ...
            while True:  # NOTER COMAND
                command = str(input("Enter command (add note, delete, show, show all, find, help, return):>> ")).lower()
                logger.debug(command)  # Логгирование
                if not command in commands:
                    answer = ""
                    while answer != "y":
